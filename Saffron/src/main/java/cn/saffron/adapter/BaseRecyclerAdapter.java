...
import cn.saffron.bean.BaseBean;

/**
 * {@link RecyclerView}数据适配器，暂仅支持同一类数据类型
 * @author timpkins
 */
public abstract class BaseRecyclerAdapter<D extends BaseBean> extends Adapter<BaseViewHolder> {
    ...
    protected abstract void onBindViewHolder(@NonNull BaseViewHolder holder, int position, @NonNull D d);
